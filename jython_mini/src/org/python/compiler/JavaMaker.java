...
public class JavaMaker extends ProxyMaker implements ClassConstants
{
	...
	public void addProxy() throws Exception
	{
		...
		int initProxy = code.pool.Methodref("org/python/core/Py", "initProxy", "(" + $pyProxy + $str + $str + $objArr + $strArr + $strArr + "Z)V");
	...
	/*
	 * public void addSuperMethod(String methodName, String superName, String
	 * superclass, Class[] parameters, Class ret, String sig, int access) throws
	 * Exception { if (!PyProxy.class.isAssignableFrom(this.superclass)) {
	...
	public void addMain() throws Exception
	{
		...
		makeStrings(code, properties);
		code.iconst(frozen ? 1 : 0);
		int runMain = code.pool.Methodref("org/python/core/Py", "runMain", "(" + $clss + $strArr + $strArr + $strArr + "Z)V");

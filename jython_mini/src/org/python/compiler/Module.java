...
class PyCodeConstant extends Constant implements ClassConstants
{
	...
	public void put(Code c) throws IOException
	{
		...
		c.iconst(moreflags);
		int mref_newCode = c.pool.Methodref("org/python/core/Py", "newCode", "(I" + $strArr + $str + $str + "IZZ" + $pyFuncTbl + "I" + $strArr + $strArr + "II)" + $pyCode);
...
public class Module implements ClassConstants, CompilationContext
{
	 ...
	 * ArgListCompiler ac, boolean fast_locals, boolean class_body) throws
	 * Exception { return PyCode(tree, name, ac, fast_locals, class_body, false,
	 * 0); } public PyCodeConstant PyCode(SimpleNode tree, String name,
	 * ArgListCompiler ac, boolean fast_locals, boolean class_body, int
	 * firstlineno) throws Exception { return PyCode(tree, name, ac,
	 * fast_locals, class_body, false, firstlineno); } public PyCodeConstant
	 * PyCode(SimpleNode tree, String name, ArgListCompiler ac, boolean
	 * fast_locals, boolean class_body, boolean printResults) throws Exception {
	...
	public PyCodeConstant PyCode(modType tree, String name, boolean fast_locals, String className, boolean classBody, boolean printResults, int firstlineno, ScopeInfo scope, org.python.core.CompilerFlags cflags) throws Exception
	{
	...
	public static void compile(modType node, OutputStream ostream, String name, String filename, boolean linenumbers, boolean printResults, boolean setFile, org.python.core.CompilerFlags cflags) throws Exception
	{
		...
		Constant main = module.PyCode(node, "?", false, null, false, printResults, 0, module.getScopeInfo(node), cflags);

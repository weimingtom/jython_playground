...
public class Code extends Attribute
{
	...
	/*
	 * cl = self.code_length() self.length = cl+12+8*len(self.exc_table)
	 * cw.put2(self.name) cw.put4(self.length) cw.put2(self.max_stack)
	 * cw.put2(len(self.locals)) cw.put4(cl) self.dump_code(cw)
	 * cw.put2(len(self.exc_table)) for start, end, handler, exc in
	 * self.exc_table: cw.put2(self.labels[start]) cw.put2(self.labels[end])
	 * cw.put2(self.labels[handler]) cw.put2(exc)

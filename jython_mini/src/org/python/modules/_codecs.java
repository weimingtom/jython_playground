	...
	private static String decode_UTF16(String str, String errors, int[] byteorder)
	{
		...
		for (int i = 0; i < size; i += 2)
		{
			...
			if (0xDC00 <= ch && ch <= 0xDFFF)
			{
				...
				{	
					/*
					 * This is valid data (a UTF-16 surrogate pair), but we are
					 * not able to store this information since our Py_UNICODE
					 * type only has 16 bits... this might change someday, even

...
public class cPickle implements ClassDictInit
{
	...
	static public class Pickler
	{
		...
		private void save(PyObject object, boolean pers_save)
		{
			...
			if (l != 2 && l != 3)
			{
				throw new PyException(PicklingError, "tuple returned by " + reduce.__repr__() + " must contain only two or three elements");
			}
	...
	static private class PickleMemo
	{
		...
		private final int[] primes = { 13, 61, 251, 1021, 4093, 5987, 9551, 15683, 19609, 31397, 65521, 131071, 262139, 524287, 1048573, 2097143, 4194301, 8388593, 16777213, 33554393, 67108859, 134217689, 268435399, 536870909, 1073741789, };

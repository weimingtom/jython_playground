...
public class _weakref implements ClassDictInit
{
	...
	{
		ReferenceError = Py.makeClass("ReferenceError", new PyObject[] { Py.RuntimeError }, Py.newJavaCode(_weakref.class, "empty__init__"), Py.None);
	...
	public static class GlobalRef extends WeakReference
	{
		...
		private int hash;
		// If the hash value was calculated by the
		// underlying object
		private boolean realHash; 

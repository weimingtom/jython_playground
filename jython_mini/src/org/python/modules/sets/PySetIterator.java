...
public class PySetIterator extends PyObject
{
	 ...
	 * <p/>
	 * <p/>
	 * This differs from the core Jython Set iterator in that it checks if the
	 * underlying Set changes in size during the course and upon completion of
	 * the iteration. A RuntimeError is raised if the Set ever changes size or
	...
	public PyObject next()
	{
		...
		if (o == null)
		{
			...
			{
				// CPython throws an exception even if you have iterated through
				// the
	 ...
	 * 
	 * @return the next item in the iteration or null to signal the end of the
	 *         iteration
	 */

...
public abstract class InternalTables
{
	...
	static InternalTables createInternalTables()
	{
		...
		if (registry == null)
		{
			throw new java.lang.IllegalStateException("Jython interpreter state not initialized. " + "You need to call PySystemState.initialize or " + "PythonInterpreter.initialize.");
		}

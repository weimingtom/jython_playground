...
public class PyInstance extends PyObject
{
	...
	public PyObject __findattr__(String name, boolean stopAtJava)
	{
		...
		if (result2[0] != null)
			// xxx do we need to use result2[1] (wherefound) for java cases for
			// backw comp?
	...
	private static synchronized void initializeIterators()
	{
		if (iterFactories != null)
			return;
		String factories = "org.python.core.CollectionIter," + "org.python.core.CollectionIter2," + Py.getSystemState().registry.getProperty("python.collections", "");
		int i = 0;

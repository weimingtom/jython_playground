...
public abstract class AbstractArray implements Serializable
{
	...
	/**
	 * The modification count increment indicates if a structural change occured
	 * as a result of an operation that would make concurrent iteration over the
	 * array invalid. It is typically used by subclasses that extend
	...
	public void remove(int start, int stop)
	{
		...
		throw new IndexOutOfBoundsException("start and stop must follow: 0 <= start <= stop <= " + (this.size - 1) + ", but found start= " + start + " and stop=" + stop);
	}

...
class BuiltinFunctions extends PyBuiltinFunctionSet
{
	...
	public PyObject __call__(PyObject arg1, PyObject arg2)
	{
		...
		{
			case 2:
				return __builtin__.range(Py.py2int(arg1, "range(): 1st arg can't be coerced to int"), Py.py2int(arg2, "range(): 2nd arg can't be coerced to int"));
	...
	public PyObject __call__(PyObject arg1, PyObject arg2, PyObject arg3)
	{
		...
		{
			case 2:
				return __builtin__.range(Py.py2int(arg1, "range(): 1st arg can't be coerced to int"), Py.py2int(arg2, "range(): 2nd arg can't be coerced to int"), Py.py2int(arg3, "range(): 3rd arg can't be coerced to int"));
	...
	/**
	 * @return arg as an interned String, or throws TypeError with mesage if
	 *         asString throws a ConversionException
	 */
	 ...
	 * 
	 * @param intern
	 *            - should the resulting string be interned
	 * @return arg as a String, or throws TypeError with message if asString

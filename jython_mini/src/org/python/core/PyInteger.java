...
public class PyInteger extends PyObject
{
	 ...
	 * @throws Py.Type
	 *             error if x.__int__ throws an Py.AttributeError
	 */
	...
	private static int divide(int x, int y)
	{
		 ...
		 * doesn't define whether xdivy is now the floor or the ceiling of the
		 * infinitely precise quotient. We want the floor, and we have it iff
		 * the remainder's sign matches y's.
		 */

...
public class PyObject implements java.io.Serializable
{
	...
	// xxx will need variants for PyType of PyType and still PyJavaClass of
	// PyJavaClass
	 ...
	 * <code>__class__</code> field to correspond to the specific subclass of
	...
	/*
	 * xxx will be replaced. This method is provided to efficiently initialize
	 * the __class__ attribute. If the following boilerplate is added to a
	 * subclass of PyObject, the instantiation time for the object will be
	 * greatly reduced.
	 * 
	 * <blockquote><pre> // __class__ boilerplate -- see PyObject for details
	 * public static PyClass __class__; protected PyClass getPyClass() { return
	 * __class__; } </pre></blockquote>
	 * 
	 * With PyIntegers this leads to a 50% faster instantiation time. This
	 * replaces the PyObject(PyClass c) constructor which is now deprecated.
	 * 
	...
	{ // xxx accelerators/ expose
		/*
		 * if (getType() == null) return null; if (name == "__class__") return
		 * getType();
		 */
		/*
		 * PyObject ret = getType().lookup(name, false); if (ret != null) return
		 * ret._doget(this); return null;
		 */
	...
	/**
	 * Equivalent to the standard Python __getattr__ method. This method can not
	 * be overridden. Override the <code>__findattr__</code> method instead.
	 * 
	 * @param name
	 *            the name to lookup in this namespace
	 ...
	 * @return null if no coercion is possible; a single PyObject to use to
	 *         replace o if this is unchanged; or a PyObject[2] consisting of
	 ...
	 *         Py.None if no coercion is possible.
	...
	/*
	 * Like _cmp_unsafe but limited to ==/!= as 0/!=0, avoids to invoke Py.id
	 */
	...
	{ // implements either __set__ or __delete__

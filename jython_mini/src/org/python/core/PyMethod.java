...
public class PyMethod extends PyObject
{
	...
	public PyObject __call__(PyObject[] args, String[] keywords)
	{
		...
		if (badcall)
		{
			...
			throw Py.TypeError("unbound method " + __name__ + "() must be " + "called with " + class_name(im_class) + " instance as first argument" + " (got " + got + " instead)");
		} else
	...
	public String toString()
	{
		...
		if (im_self == null)
			...
			return "<method " + classname + "." + __name__ + " of " + class_name(im_self.fastGetClass()) + " instance " + Py.idstr(im_self) + ">";
	}
}

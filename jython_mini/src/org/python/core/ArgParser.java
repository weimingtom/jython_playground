...
public class ArgParser
{
	 ...
	 * 
	 * @param funcname
	 *            Name of the method. Used in error messages.
	 * @param args
	 ...
	 *            The actual keyword names supplied in the call.
	 * @param p0
	 *            The first expected argument in the method definition.
	 * @param p1
	...
	public ArgParser(String funcname, PyObject[] args, String[] kws, String[] paramnames, int minargs)
	{
		...
		{
			throw PyBuiltinFunction.DefaultInfo.unexpectedCall(args.length, false, funcname, minargs, this.params.length);
		}
	}
	...
	private Object getArg(int pos, Class clss, String classname, Object def)
	{
		...
		{
			throw Py.TypeError("argument " + (pos + 1) + ": expected " + classname + ", " + Py.safeRepr(value) + " found");
		}
		return ret;
	}

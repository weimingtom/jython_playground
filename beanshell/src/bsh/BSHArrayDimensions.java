...
class BSHArrayDimensions extends SimpleNode
{
	...
	public Object eval_2(Class type, CallStack callstack, Interpreter interpreter) throws EvalError
	{
	...
	public Object eval(CallStack callstack, Interpreter interpreter) throws EvalError
	{
		...
		/*
		 * Child is array initializer. Evaluate it and fill in the dimensions it
		 * returns. Initialized arrays are always fully defined (no undefined
		 * dimensions to worry about). The syntax uses the undefinedDimension
		 * count. e.g. int [][] { 1, 2 };
		 */
		if (child instanceof BSHArrayInitializer)
		{
			...
			Object initValue = ((BSHArrayInitializer) child).eval_2(baseType, numUndefinedDims, callstack, interpreter);

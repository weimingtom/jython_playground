...
public class BshMethod implements java.io.Serializable
{
	...
	{
		return invoke_3(argValues, interpreter, null, null, false);
	}
	 ...
	 */
	public Object invoke_2(Object[] argValues, Interpreter interpreter, CallStack callstack, SimpleNode callerInfo) throws EvalError
	{
		return invoke_3(argValues, interpreter, callstack, callerInfo, false);
	}
	 ...
	 */
	Object invoke_3(Object[] argValues, Interpreter interpreter, CallStack callstack, SimpleNode callerInfo, boolean overrideNameSpace) throws EvalError
	{
		if (argValues != null)
		{	
	...
	private Object invokeImpl(Object[] argValues, Interpreter interpreter, CallStack callstack, SimpleNode callerInfo, boolean overrideNameSpace) throws EvalError
	{
		...
		for (int i = 0; i < numArgs; i++)
		{
			...
			if (paramTypes[i] != null)
			{
				...
				try
				{
					localNameSpace.setTypedVariable_2(paramNames[i], paramTypes[i], argValues[i], null/* modifiers */);
				} 
				catch (UtilEvalError e2)
				{
					throw e2.toEvalError_2("Typed method parameter assignment", callerInfo, callstack);
				}
			}
		...
		Object ret = methodBody.eval_2(callstack, interpreter, true/* override */);
		...
		if (returnType != null)
		{
			...
			catch (UtilEvalError e)
			{
				...
				throw e.toEvalError_2("Incorrect type returned from method: " + name + e.getMessage(), node, callstack);
			}
		}
		return ret;
	}

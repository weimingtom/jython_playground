...
public class Parser/* @bgen(jjtree) */implements ParserTreeConstants, ParserConstants
{
	...
	{
		jj_input_stream.ReInit_5(in, jj_input_stream.getEndLine(), jj_input_stream.getEndColumn());
	}
	...
	/*
	 * Gather modifiers for a class, method, or field. I lookahead is true then
	 * we are being called as part of a lookahead and we should not enforce any
	 * rules. Otherwise we validate based on context (field, method, class)
	 */
...
*/
	final public void ClassDeclaration() throws ParseException
	{
		...
		try
		{
			...
			Block();
			jjtree.closeNodeScope_2(jjtn000, true);
			jjtc000 = false;
	 ...
	 * 
	 * void VariableDeclaratorId() #VariableDeclaratorId : { Token t; } {
		...
		switch ((jj_ntk == -1) ? jj_ntk() : jj_ntk)
		{
			case HOOK:
				...
				finally
				{
					if (jjtc001)
					{
						jjtree.closeNodeScope_3(jjtn001, 3);
	...
	final public void ConditionalOrExpression() throws ParseException
	{
		...
		label_7: while (true)
		{
			...
			try
			{
				jjtree.closeNodeScope_3(jjtn001, 2);
				jjtc001 = false;
				jjtreeCloseNodeScope(jjtn001);
				jjtn001.kind = t.kind;
			} 
	...
	final public void UnaryExpression() throws ParseException
	{
		...
		switch ((jj_ntk == -1) ? jj_ntk() : jj_ntk)
		{
			...
			case MINUS:
				...
				try
				{
					jjtree.closeNodeScope_3(jjtn001, 1);
					jjtc001 = false;
					jjtreeCloseNodeScope(jjtn001);
					jjtn001.kind = t.kind;
				} 
	...
	final public void FormalComment() throws ParseException
	{
		...
		try
		{
			...
			jjtree.closeNodeScope_2(jjtn000, retainComments);
			jjtc000 = false;
			jjtreeCloseNodeScope(jjtn000);
	...
	/*
	 * Do statement is just a While statement with a special hook to execute at
	 * least once.
	 */
	...
	/*
	 * The new JDK1.5 enhanced for statement. e.g. for( int a : arrayOfInts ) {
	 * } We also support loose typing of the iterator var for BeanShell e.g.
	 * for( a : arrayOfInts ) { }
	 */
	...
	{
		jj_input_stream.ReInit_3(stream, 1, 1);
	...
	public void ReInit_3(Reader stream)
	{
		jj_input_stream.ReInit_5(stream, 1, 1);
		token_source.ReInit(jj_input_stream);
		token = new Token();
		jj_ntk = -1;
		jjtree.reset();
	...
	public void ReInit_2(ParserTokenManager tm)
	{
		token_source = tm;
		token = new Token();
		jj_ntk = -1;

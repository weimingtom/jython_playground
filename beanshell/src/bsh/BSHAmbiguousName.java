...
class BSHAmbiguousName extends SimpleNode
{
	...
	Object toObject_2(CallStack callstack, Interpreter interpreter, boolean forceClass) throws EvalError
	{
		try
		{
			return getName(callstack.top()).toObject_2(callstack, interpreter, forceClass);
		} 
	...
	/*
	 * The interpretation of an ambiguous name is context sensitive. We disallow
	 * a generic eval( ).
	 */

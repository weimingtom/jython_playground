...
class BlockNameSpace extends NameSpace
{
	 ...
	 */
	public void setVariable_2(String name, Object value, boolean strictJava, boolean recurse) throws UtilEvalError
	{
		if (weHaveVar(name))
		{	
			// set the var here in the block namespace
			super.setVariable_2(name, value, strictJava, false);
		}
		else
		{	
			// set the var in the enclosing (parent) namespace
			getParent().setVariable_2(name, value, strictJava, recurse);
		}
	}
	...
	{
		super.setVariable_2(name, value, false/* strict? */, false);
	}

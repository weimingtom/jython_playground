 ...
 */
public class NameSpace implements Serializable, BshClassManagerListener, NameSource
{
	...
	*/
	...
	public void setVariable(String name, Object value, boolean strictJava) throws UtilEvalError
	{
		...
		setVariable_2(name, value, strictJava, recurse);
	}
	...
	{
		setVariable_2(name, value, strictJava, false/* recurse */);
	}
	 ...
	 */
	void setVariable_2(String name, Object value, boolean strictJava, boolean recurse) throws UtilEvalError
	{
		if (variables == null)
		{
	...
	public void setVariableOrProperty(String name, Object value, boolean strictJava) throws UtilEvalError
	{
		// if localscoping switch follow strictJava, else recurse
		boolean recurse = Interpreter.LOCALSCOPING ? strictJava : true;
		setVariableOrProperty_2(name, value, strictJava, recurse);
	}
	...
	{
		setVariableOrProperty_2(name, value, strictJava, false/* recurse */);
	}
	 ...
	 *            parent's scope before assigning locally.
	 */
	void setVariableOrProperty_2(String name, Object value, boolean strictJava, boolean recurse) throws UtilEvalError
	{
		if (variables == null)
		{
			variables = new Hashtable();
	...
	{
		Object val = getVariable_2(name, true);
	...
	{
		return getVariable_2(name, true);
	}
	 ...
	 * @return The variable value or Primitive.VOID if it is not defined.
	 */
	public Object getVariable_2(String name, boolean recurse) throws UtilEvalError
	{
	...
	public void setTypedVariable(String name, Class type, Object value, boolean isFinal) throws UtilEvalError
	{
		...
		setTypedVariable_2(name, type, value, modifiers);
	}
	 ...
	 *            may be null
	 */
	public void setTypedVariable_2(String name, Class type, Object value, Modifiers modifiers) throws UtilEvalError
	{
	...
	/**
	 * @see #getMethod_2(String, Class [], boolean )
	 * @see #getMethod(String, Class [] )
	 */
	public BshMethod getMethod(String name, Class[] sig) throws UtilEvalError
	{
		return getMethod_2(name, sig, false/* declaredOnly */);
	}
	 ...
	 *            visible.
	 */
	public BshMethod getMethod_2(String name, Class[] sig, boolean declaredOnly) throws UtilEvalError
	{
	...
	public void importClass(String name)
	{
		...
		importedClasses.put(Name.suffix_2(name, 1), name);
		nameSpaceChanged();
	}
	...
	private BshMethod loadScriptedCommand(InputStream in, String name, Class[] argTypes, String resourcePath, Interpreter interpreter) throws UtilEvalError
	{
		try
		{
			interpreter.eval_2(new InputStreamReader(in), this, resourcePath);
		}
		catch (EvalError e)
		{
			/*
	 ...
	 * names in this space.
	 */
	public void addNameSourceListener(NameSourceListener listener)
	{
	...
	{
		return invokeMethod_2(methodName, args, interpreter, null, null);
	}
	 ...
	 *      )
	 */
	public Object invokeMethod_2(String methodName, Object[] args, Interpreter interpreter, CallStack callstack, SimpleNode callerInfo) throws EvalError
	{
		return getThis(interpreter).invokeMethod_2(methodName, args, interpreter, callstack, callerInfo, false/* declaredOnly */);
	}

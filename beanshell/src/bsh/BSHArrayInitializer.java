...
class BSHArrayInitializer extends SimpleNode
{
	 ...
	 *            [][];
	 */
	public Object eval_2(Class baseType, int dimensions, CallStack callstack, Interpreter interpreter) throws EvalError
	{
		...
		for (int i = 0; i < numInitializers; i++)
		{
			...
			if (node instanceof BSHArrayInitializer)
			{
				...
				currentInitializer = ((BSHArrayInitializer) node).eval_2(baseType, dimensions - 1, callstack, interpreter);
			} 
			else
			{
			...
			if (dimensions == 1)
			{
				...
				{
					throw e.toEvalError_2("Error in array initializer", this, callstack);
				}

...
class BSHForStatement extends SimpleNode implements ParserConstants
{
	...
	public Object eval(CallStack callstack, Interpreter interpreter) throws EvalError
	{
		 ...
		 * 
		 * 1) We swap instead of push... The primary mode of operation acts like
		 * we are in the enclosing namespace... (super must be preserved, etc.)
		 * 
		 * 2) We do *not* call the body block eval with the namespace override.
		 * Instead we allow it to create a second subordinate BlockNameSpace
		 * child of the forNameSpace. Variable propogation still works through

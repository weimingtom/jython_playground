...
class LHS implements ParserConstants, Serializable
{
	...
	/**
	 * @param localVar
	 *            if true the variable is set directly in the This reference's
	 *            local scope. If false recursion to look for the variable
	 *            definition in parent's scope is allowed. (e.g. the default
	 *            case for undefined vars going to global).
	 */

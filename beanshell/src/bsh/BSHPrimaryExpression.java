...
class BSHPrimaryExpression extends SimpleNode
{
	...
	{
		return eval_2(false, callstack, interpreter);
	}
	...
	{
		Object obj = eval_2(true, callstack, interpreter);
	 ...
	 * 
	 * We don't eval() any nodes until the suffixes have had an opportunity to
	 * work through them. This lets the suffixes decide how to interpret an
	 * ambiguous name (e.g. for the .class operation).
	 */
	private Object eval_2(boolean toLHS, CallStack callstack, Interpreter interpreter) throws EvalError
	{
		...
		/*
		 * If the result is a Node eval() it to an object or LHS (as determined
		 * by toLHS)
		 */

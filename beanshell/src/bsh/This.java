...
public class This implements Serializable, Runnable
{
	 ...
	 * interfaces.
	 */
	public Object getInterface_2(Class[] ca) throws UtilEvalError
	{
	...
	public Object invokeMethod(String name, Object[] args) throws EvalError
	{
		...
		return invokeMethod_2(name, args, null/* declaringInterpreter */, null, null, false/* declaredOnly */);
	}
	 ...
	 * @param declaredOnly
	 *            if true then only methods declared directly in the namespace
	 *            will be visible - no inherited or imported methods will be
	 *            visible.
	 * @see bsh.Primitive
	 */
	/*
	 ...
	 */
	public Object invokeMethod_2(String methodName, Object[] args, Interpreter interpreter, CallStack callstack, SimpleNode callerInfo, boolean declaredOnly) throws EvalError
	{
		/*
		...
		try
		{
			bshMethod = namespace.getMethod_2(methodName, types, declaredOnly);
		} 
		...
		if (bshMethod != null)
		{
			return bshMethod.invoke_2(args, interpreter, callstack, callerInfo);
		}
		/*
		...
		if (bshMethod != null)
		{
			return bshMethod.invoke_2(new Object[] { methodName, args }, interpreter, callstack, callerInfo);
		}

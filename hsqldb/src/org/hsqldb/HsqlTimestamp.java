...
/**
 * Insert the type's description here. Creation date: (2/2/01 4:09:38 PM)
 * 
...
public abstract class HsqlTimestamp {
    ...
    /*
     * public static void main(String[] args) { String tests[] = { "2000-1-1",
     * "2000-1-1 12:13", "2000-1-1 12:13:14", "2000-1-1 12:13:14.15" }; for(int
     * i =0; i <tests.length;i++) { String test = tests[i];
     * System.out.print("test "+test + " = "); try {
     * System.out.println(HsqlTimestamp.valueOf(test)); } catch(Exception e) {
     ...
     * 
     * @param s
     *            timestamp in format <code>yyyy-mm-dd hh:mm:ss.fffffffff</code>
	...
	final int month = Integer.parseInt(date_s.substring(firstDash + 1,
		secondDash)) - 1;

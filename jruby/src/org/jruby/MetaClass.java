...
public class MetaClass extends RubyClass
{
	...
	/**
	 * If an object uses an anonymous class 'class << obj', then this grabs the
	 * original metaclass and not the one that get injected as a result of
	 * 'class << obj'.
	 */
	...
	{
		// Though it may not be obvious, attachToObject is always called just
		// after instance

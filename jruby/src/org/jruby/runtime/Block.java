...
public class Block implements StackElement
{
	...
	public static Block createBlock(Node var, ICallable method, IRubyObject self)
	{
		...
		return new Block(var, method, self, context.getCurrentFrame(), context.peekCRef(), context.getCurrentScope(), context.getRubyClass(), context.getCurrentIter(), context.getCurrentDynamicVars());
	}

	public Block(Node var, ICallable method, IRubyObject self, Frame frame, SinglyLinkedList cref, Scope scope, RubyModule klass, Iter iter, DynamicVariableSet dynamicVars)
	{

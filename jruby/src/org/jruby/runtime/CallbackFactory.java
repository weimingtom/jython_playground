...
/**
 * Helper class to build Callback method. This impements method corresponding to
 * the signature of method most often found in the Ruby library, for methods
 * with other signature the appropriate Callback object will need to be
 * explicitly created.
 **/
public abstract class CallbackFactory
{
	 ...
	 *            name of the method
	 * @param arg1
	 *            the java class of the first argument for this method
	 * @param arg2
	...
	/**
	 * gets a singleton (class) method with no mandatory argument and some
	 * optional arguments.
	 * 
	 * @param method
	 *            name of the method
	...
	/**
	 * gets an instance method with no mandatory argument and some optional
	 * arguments.
	 * 
	 * @param method
	 *            name of the method

...
/**
 * A Scope in the Ruby Stack of scopes. This is used to maintain a stack of
 * scopes through a linked list. Each scope holds a list of local values and a
 * list of local names Each scope also hold a pointer to the previous scope, a
 * new empty scope can be pushed on top of the stack using the push method, the
 * top scope can be popped of the top of the stack using the pop method.
 * 
 * @author jpetersen
 */
public class Scope
{
	...
	private static final String[] SPECIAL_VARIABLE_NAMES = new String[] { "_", "~" };
	...
	private Visibility visibility = Visibility.PUBLIC; // Constants.SCOPE_PRIVATE;
														// ? // Same as default
														// for top level...just
														// in case

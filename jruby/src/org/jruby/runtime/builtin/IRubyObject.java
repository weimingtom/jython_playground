...
/**
 * Object is the parent class of all classes in Ruby. Its methods are therefore
...
public interface IRubyObject
{
	...
	/**
	 * Make sure the arguments fit the range specified by minimum and maximum.
	 * On a failure, The Ruby runtime will generate an ArgumentError.
	 * 
	 * @param arguments
	 *            to check
	 * @param minimum
	 *            number of args
	 * @param maximum
	 *            number of args (-1 for any number of args)

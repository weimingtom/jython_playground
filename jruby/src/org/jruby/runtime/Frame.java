...
public class Frame
{
	...
	{
		this(threadContext.getRuntime(), null, IRubyObject.NULL_ARRAY, null, null, threadContext.getPosition(), iter);
	}

	public Frame(ThreadContext threadContext, IRubyObject self, IRubyObject[] args, String lastFunc, RubyModule lastClass)
	{
		this(threadContext.getRuntime(), self, args, lastFunc, lastClass, threadContext.getPosition(), threadContext.getCurrentIter());
	}

	private Frame(IRuby runtime, IRubyObject self, IRubyObject[] args, String lastFunc, RubyModule lastClass, ISourcePosition position, Iter iter)
	{
		this.self = self;
		this.args = args;

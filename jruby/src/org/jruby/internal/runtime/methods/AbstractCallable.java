...
public abstract class AbstractCallable implements ICallable
{
	...
	/**
	 * The base behavior is to do no scope/frame manipulation at all, depending
	 * on the caller. Methods (via AbstractMethod) add their own behavior for
	 * scoping/framing, and non-methods (Evaluate/IterateCallable) are only
	 * invoked from within ThreadContext.yield. Eventually TC.yield
	 * scoping/framing may be moved into superclass of the two non-methods.
	 */

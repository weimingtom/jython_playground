...
public class ReflectedMethod extends AbstractMethod
{
	...
	public ReflectedMethod(RubyModule implementationClass, Class type, String methodName, Arity arity, Visibility visibility)
	{
	...
	{
		ReflectedMethod newMethod = new ReflectedMethod(getImplementationClass(), type, methodName, arity, getVisibility());
	...
	// TODO: Perhaps abstract method should contain this and all other Methods
	// should pass in decent value

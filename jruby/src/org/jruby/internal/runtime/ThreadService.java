...
public class ThreadService
{
	...
	public ThreadService(IRuby runtime)
	{
		...
		// Must be called from main thread (it is currently, but this bothers
		// me)
	...
	public synchronized void setCritical(boolean critical)
	{
		...
		if (criticalThread != null)
		{
			...
			{
				// we're not the critical thread, do nothing (TODO: or perhaps
				// wait on the critical thread here?)
				return;
			}

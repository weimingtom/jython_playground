...
/**
 * This class is used to provide an intermediate superclass for modules and
 * classes that include other modules. It inserts itself as the immediate
 * superClass of the includer, but defers all module methods to the actual
 * superclass. Multiple of these intermediate superclasses can be added for
 * multiple included modules.
 * 
 * This allows the normal superclass-based searches (searchMethod, getConstant,
 * etc) to traverse the superclass ancestors as normal while the included
 * modules do not actually show up in direct inheritance traversal.
 * 
...
public final class IncludedModuleWrapper extends RubyClass
{
	...
	/**
	 * Overridden newIncludeClass implementation to allow attaching future
	 * includes to the correct module (i.e. the one to which this is attached)
	 * 

...
public class IOHandlerSeekable extends IOHandlerJavaIO
{
	...
	public IOHandlerSeekable(IRuby runtime, String path, IOModes modes) throws IOException, InvalidValueException
	{
		super(runtime);
		...
		// Do not open as 'rw' if we don't need to since a file with permissions
		// for read-only
	...
	public void seek(long offset, int type) throws IOException, InvalidValueException
	{
		...
		// TODO: This seems wrong...Invalid value should be for switch..not any
		// IOError?
		try
		{
			switch (type)

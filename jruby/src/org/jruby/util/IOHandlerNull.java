...
public class IOHandlerNull extends IOHandler
{
	...
	public String gets(String separatorString) throws IOException, BadDescriptorException, EOFException
	{
	...
	public String read(int number) throws IOException, BadDescriptorException, EOFException
	{
		throw new EOFException();
	}

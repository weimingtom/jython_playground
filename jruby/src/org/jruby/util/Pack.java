...
public class Pack
{
	...
	/**
	 * encodes a String in base64 or its uuencode variant. appends the result of
	 * the encoding in a StringBuffer
	 * 
	 * @param io2Append
	 *            The StringBuffer which should receive the result
	 * @param i2Encode
	 *            The String to encode
	 * @param iLength
	 *            The max number of characters to encode
	 * @param iType
	 *            the type of encoding required (this is the same type as used
	 *            by the pack method)
	...
	private static StringBuffer qpencode(StringBuffer io2Append, String i2Encode, int iLength)
	{
		...
		{
			// normal exit, this should be faster than a test at each iterations
			// for string with more than
			// about 40 char
		}
	...
	private static String convert2String(IRubyObject l2Conv)
	{
		...
		{
			l2Conv = l2Conv.convertToType("String", "to_s", true); // we may
																	// need a
																	// false
																	// here, not
																	// sure
	 ...
	 * string consists of a sequence of single-character directives.<br/>
	 * Each directive may be followed by a number, indicating the number of
	 * times to repeat with this directive. An asterisk (``<code>*</code>'')
	 * will use up all remaining elements. <br/>
	 ...
	 * 
	 * @see RubyArray#pack <table border="2" width="500" bgcolor="#ffe0e0">
	 *      <tr>
	 *      <td>
	 *      <P>
	 *      </P>
	 *      <b>Directives for <a href="ref_c_string.html#String.unpack">
	 *      <code>String#unpack</code> </a> </b>
	 ...
	 *      <tr>
	 *      <td valign="top">d</td>
	 *      <td valign="top">Treat <em>sizeof(double)</em> characters as a
	 *      native double.</td>
	 ...
	 *      <td valign="top">E</td>
	 *      <td valign="top">Treat <em>sizeof(double)</em> characters as a
	 *      double in little-endian byte order.</td>
	 *      <td valign="top">Float</td>
	 *      </tr>
	 *      <tr>
	 *      <td valign="top">e</td>
	 *      <td valign="top">Treat <em>sizeof(float)</em> characters as a float
	 *      in little-endian byte order.</td>
	 *      <td valign="top">Float</td>
	 *      </tr>
	 *      <tr>
	 *      <td valign="top">f</td>
	 *      <td valign="top">Treat <em>sizeof(float)</em> characters as a native
	 *      float.</td>
	 *      <td valign="top">Float</td>
	 *      </tr>
	 *      <tr>
	 *      <td valign="top">G</td>
	 *      <td valign="top">Treat <em>sizeof(double)</em> characters as a
	 *      double in network byte order.</td>
	 *      <td valign="top">Float</td>
	 *      </tr>
	 *      <tr>
	 *      <td valign="top">g</td>
	 ...
	 *      <tr>
	 *      <td valign="top">I</td>
	 *      <td valign="top">Treat <em>sizeof(int)</em> <sup>1</sup> successive
	 ...
	 *      <tr>
	 *      <td valign="top">L</td>
	 *      <td valign="top">Treat four<sup>1</sup> successive characters as an
	 *      unsigned native long integer.</td>
	 *      <td valign="top">Integer</td>
	 *      </tr>
	 *      <tr>
	 *      <td valign="top">l</td>
	 *      <td valign="top">Treat four<sup>1</sup> successive characters as a
	 *      signed native long integer.</td>
	 *      <td valign="top">Integer</td>
	 *      </tr>
	 *      <tr>
	 *      <td valign="top">M</td>
	 ...
	 *      <tr>
	 *      <td valign="top">N</td>
	 *      <td valign="top">Treat four characters as an unsigned long in
	 *      network byte order.</td>
	 *      <td valign="top">Fixnum</td>
	 *      </tr>
	 *      <tr>
	 *      <td valign="top">n</td>
	 *      <td valign="top">Treat two characters as an unsigned short in
	 *      network byte order.</td>
	 *      <td valign="top">Fixnum</td>
	 *      </tr>
	 *      <tr>
	 *      <td valign="top">P</td>
	 *      <td valign="top">Treat <em>sizeof(char *)</em> characters as a
	 *      pointer, and return <em>len</em> characters from the referenced
	 *      location.</td>
	 *      <td valign="top">String</td>
	 *      </tr>
	 *      <tr>
	 *      <td valign="top">p</td>
	 *      <td valign="top">Treat <em>sizeof(char *)</em> characters as a
	 *      pointer to a null-terminated string.</td>
	 *      <td valign="top">String</td>
	 *      </tr>
	 *      <tr>
	 *      <td valign="top">S</td>
	 *      <td valign="top">Treat two<sup>1</sup> successive characters as an
	 *      unsigned short in native byte order.</td>
	 *      <td valign="top">Fixnum</td>
	 *      </tr>
	 *      <tr>
	 *      <td valign="top">s</td>
	 *      <td valign="top">Treat two<sup>1</sup> successive characters as a
	 *      signed short in native byte order.</td>
	 *      <td valign="top">Fixnum</td>
	 *      </tr>
	 *      <tr>
	 *      <td valign="top">U</td>
	 ...
	 *      </tr>
	 *      <tr>
	 *      <td colspan="9" bgcolor="#ff9999" height="2"><img src="dot.gif"
	 *      width="1" height="1"></td>
	 *      </tr>
	 *      </table>
	 *      <P>
	 *      </P>
	 *      <sup>1</sup>&nbsp;May be modified by appending ``_'' to the
	 *      directive.
	 *      <P>
	 *      </P></td>
	 *      </tr>
			...
			switch (type)
			{
				...
				case 'm':
				{
					...
					while (!encode.isAtEnd())
					{
						...
						if ((a = b64_xtable[s]) == -1)
							break;
						if ((b = b64_xtable[s = encode.nextChar()]) == -1)
							break;
						if ((c = b64_xtable[s = encode.nextChar()]) == -1)
							break;
						if ((d = b64_xtable[s = encode.nextChar()]) == -1)
							break;
	...
	static class PtrList
	{
		...
		/**
		 * <p>
		 * Get substring from current point of desired length and advance
		 * pointer.
		 * </p>
		 * 
		 * @param length
		...
		/**
		 * @return char at the pointer (advancing the pointer) or '\0' if at
		 *         end.
		 * 
		 *         Note: the pointer gets advanced one past last character to
		 *         indicate that the whole buffer has been read.
		 */
		...
		/**
		 * <p>
		 * Backup the pointer occurrences times.
		 * </p>
		 * 
		 * @throws IllegalArgumentException
		 *             if it backs up past beginning of buffer
		 */
	...
	/**
	 * grows a stringbuffer. uses the Strings to pad the buffer for a certain
	 * length
	 * 
	 * @param i2Grow
	 *            the buffer to grow
	 ...
	 * </tr>
	 * <tr>
	 * <td colspan="9" bgcolor="#ff9999" height="2"><img src="dot.gif" width="1"
	 * height="1"></td>
	 * </tr>
	 * </table>
	 * 
	 ...
	 * directives in aTemplateString (see preceding table). Directives ``A,''
	 * ``a,'' and ``Z'' may be followed by a count, which gives the width of the
	 * resulting field. The remaining directives also may take a count,
	 * indicating the number of array elements to convert. If the count is an
	 * asterisk (``*''), all remaining array elements will be converted. Any of
	 * the directives ``sSiIlL'' may be followed by an underscore (``_'') to use
				...
				case 'h':
				{
					...
					switch (type)
					{
						...
						case 'Z':
							...
							{// need padding
								// I'm fairly sure there is a library call to
								// create a
								// string filled with a given char with a given
								// length but I couldn't find it
						...
						// I believe there is a bug in the b and B case we skip
						// a char too easily
						case 'b':
						{
							int currentByte = 0;
							...
							for (int i = 0; i < occurrences;)
							{
								...
								{// if the low bit is set
									currentByte |= 128; // set the high bit of
														// the result
								}
								...
								// if the index is not a multiple of 8, we are
							...
							{ // if the length is not a multiple of 8
								currentByte >>= 7 - (occurrences & 7); // we
																		// need
																		// to
																		// pad
																		// the
							...
							// do some padding, I don't understand the padding
							// strategy
						...
						case 'B':
						{
							...
							for (int i = 0; i < occurrences;)
							{
								...
								// we filled up current byte; append it and
								// create next one
								if ((i & 7) == 0)
								{
									result.append((char) (currentByte & 0xff));
						...
						case 'h':
						{
							...
							for (int i = 0; i < occurrences;)
							{
								...
								{
									// this test may be too lax but it is the
									// same as in MRI
	...
	/**
	 * Retrieve an encoded int in little endian starting at index in the string
	 * value.
	 * 
	 * @param encode

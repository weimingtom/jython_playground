...
/**
 * This class provides a File implementation that normalizes all path separators
 * to forward slashes. This mimics the behavior of C Ruby, where all paths are
 * internally made UNIX-style, even on Windows.
 */

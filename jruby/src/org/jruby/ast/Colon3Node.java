...
/**
 * Global scope node. Node produced when using :: without a scope in front. This
 * is used to gain access to the global scope (that of the Object class) when
 * refering to a constant or method. This is the same as a Colon2Node but with

...
/**
 * Block passed explicitly as an argument in a method call. A block passing
 * argument in a method call (last argument prefixed by an ampersand).
 * 
 * @author jpetersen
 */
public class BlockPassNode extends Node
{
	...
	/**
	 * Used by the arg_blk_pass and new_call, new_fcall and new_super methods in
	 * ParserSupport to temporary save the args node.
	 */

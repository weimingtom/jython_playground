...
public interface IOSEnvironmentReader
{
	 ...
	 * 
	 * Returns an string map view of the current system environment. If
	 * environment variables,are not supported, then null is returned.
	 * (isEnvironmentAccessible() returns false). If there are no variables
	 * defined, then an empty Map is returned.
	 * 

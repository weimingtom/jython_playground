...
public class RubyArgsFile extends RubyObject
{
	...
	public void initArgsFile()
	{
		...
		// defineSingletonMethod("gets",
		// callbackFactory.getOptSingletonMethod(RubyGlobal.class, "gets"));
		// defineSingletonMethod("readline",
		// callbackFactory.getOptSingletonMethod(RubyGlobal.class, "readline"));
		// defineSingletonMethod("readlines",
		// callbackFactory.getOptSingletonMethod(RubyGlobal.class,
		// "readlines"));

		// defineSingletonMethod("to_a",
		// callbackFactory.getOptSingletonMethod(RubyGlobal.class,
		// "readlines"));

...
public class Java
{
	...
	/**
	 * High-level object conversion utility function 'java_to_primitive' is the
	 * low-level version
	 */
	public static IRubyObject java_to_ruby(IRubyObject recv, IRubyObject object)
	{
		...
		// if
		// (object.isKindOf(recv.getRuntime().getModule("Java").getClass("JavaObject")))
		// {
		if (object instanceof JavaObject)
		{
	...
	public static IRubyObject new_proxy_instance(final IRubyObject recv, IRubyObject[] args)
	{
		...
		// Create list of interfaces to proxy (and make sure they really are
		// interfaces)

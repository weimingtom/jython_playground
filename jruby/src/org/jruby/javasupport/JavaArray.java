...
public class JavaArray extends JavaObject
{
	...
	public IRubyObject aref(IRubyObject index)
	{
		...
		{
			throw getRuntime().newArgumentError("index out of bounds for java array (" + intIndex + " for length " + getLength() + ")");
		}
	...
	public IRubyObject aset(IRubyObject index, IRubyObject value)
	{
		...
		{
			throw getRuntime().newArgumentError("wrong element type " + javaObject.getClass() + "(array is " + getValue().getClass() + ")");
		}
		return value;
	}
}

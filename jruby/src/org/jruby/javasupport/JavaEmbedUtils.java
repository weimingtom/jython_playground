...
/**
 * Utility functions to help embedders out. These function consolidate logic
 * that is used between BSF and JSR 223. People who are embedding JRuby 'raw'
 * should use these as well. If at a later date, we discover a flaw or change
 * how we do things, this utility class should provide some insulation.
 * 
 */
public class JavaEmbedUtils
{
	/**
	 * Get an instance of a JRuby runtime. Provide any loadpaths you want used
	 * at startup.
	 * 
	 * @param loadPaths
	 ...
	 * 
	 * @param runtime
	 *            environment where the invoke will occur
	 * @param receiver
	 *            is the instance that will receive the method call
	 * @param method
	 *            is method to be called
	 * @param args
	 *            are the arguments to the method
	 * @param returnType

...
public class RubyFixnum extends RubyInteger
{
	...
	public IRubyObject op_lshift(IRubyObject other)
	{
		if (other instanceof RubyNumeric)
		{
			...
			if (value > 0)
			{
				...
				{
					RubyBignum bigValue = RubyBignum.newBignum(getRuntime(), RubyBignum.bigIntValue(this));
	...
	public IRubyObject op_minus(IRubyObject other)
	{
		...
		} else
		{
			...
			long result = value - otherValue;
			if ((value <= 0 && otherValue >= 0 && (result > 0 || result < -MAX)) || (value >= 0 && otherValue <= 0 && (result < 0 || result > MAX)))
			{
				return RubyBignum.newBignum(getRuntime(), value).op_minus(other);
			}
			return newFixnum(result);
	...
	public IRubyObject op_plus(IRubyObject other)
	{
		...
		} else if (other instanceof RubyFixnum)
		{
			...
			long result = value + otherValue;
			if (other instanceof RubyBignum || (value < 0 && otherValue < 0 && (result > 0 || result < -MAX)) || (value > 0 && otherValue > 0 && (result < 0 || result > MAX)))
			{

...
public class LocalNamesElement
{
	...
	/**
	 * Returns true if there was already an assignment to a local variable named
	 ...
	 * @return true if there was already an assignment to a local variable named
	 *         id.
	 */
	...
	/**
	 * Returns the index of the local variable 'name' in the table of registered
	 * variable names.
	 * 
	 * If name is not registered yet, register the variable name.
	 * 
	 * If name == null returns the count of registered variable names. MRI: cf
	 * local_cnt
	 * 
	 * @todo: this method is often used for its side effect (for registering a
	 *        name) it should either be renamed or an other method without a
	 *        return and with a better name should be used for this. the
	 *        getLocalIndex name makes one believe the main purpose of this
	 *        method is getting something while the result is often ignored.
	 *@param name
	 *            The name of the local variable
	...
	/**
	 * Register the local variable name 'name' in the table of registered
	 * variable names. Returns the index of the added local variable name in the
	 * table.
	 * 
	 * MRI: cf local_append
	 * 

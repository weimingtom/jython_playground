...
public class RubyGlobal
{
	public static void createGlobals(IRuby runtime)
	{
		...
		// Fixme: Do we need the check or does Main.java not call this...they
		// should consolidate
	...
	private static void defineGlobalEnvConstants(IRuby runtime)
	{
		...
		{
			// if the environment variables can't be obtainded, define an empty
			// ENV
	...
	private static class SafeGlobalVariable extends GlobalVariable
	{
		...
		public IRubyObject set(IRubyObject value)
		{
			...
			{
				throw runtime.newSecurityError("tried to downgrade safe level from " + runtime.getSafeLevel() + " to " + level);
			}

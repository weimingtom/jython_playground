...
public class RubyJRuby
{
	public static RubyModule createJRuby(IRuby runtime)
	{
		...
		comparableModule.defineModuleFunction("parse", callbackFactory.getSingletonMethod("parse", IRubyObject.class, IRubyObject.class));
	...
	public static IRubyObject parse(IRubyObject recv, IRubyObject arg1, IRubyObject arg2)
	{
		...
		return Java.java_to_ruby(recv, JavaObject.wrap(recv.getRuntime(), recv.getRuntime().parse(content.toString(), filename.toString())));
	}
}

...
public class RubyClass extends RubyModule
{
	...
	public static RubyClass newClass(IRubyObject recv, IRubyObject[] args)
	{
		...
		if (args.length > 0)
		{
			...
			{
				throw runtime.newTypeError("wrong argument type " + args[0].getType().getName() + " (expected Class)");
			}
		} else
		{
	...
	/**
	 * Creates a new object of this class by calling the 'allocateObject'
	 * method. This class must be the type of the new object.
	 * 
	...
	/**
	 * <p>
	 * This method is a constructor for ruby objects. It is called by the
	 * "Class#new", "Object#clone" and Object#dup" to create new object
	 * instances.
	 * </p>
	 * <p>
	 * Builtin meta classes (subclasses of {@link ObjectMetaClass}) have to
	 * override this method to create instances of the corresponding subclass of
	 * RubyObject.
	 * </p>
	 * <p>

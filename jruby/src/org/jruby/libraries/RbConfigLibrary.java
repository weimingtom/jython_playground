...
{
	/**
	 * Just enough configuration settings (most don't make sense in Java) to run
	 * the rubytests unit tests. The tests use <code>bindir</code>,
	 * <code>RUBY_INSTALL_NAME</code> and <code>EXEEXT</code>.
	 */

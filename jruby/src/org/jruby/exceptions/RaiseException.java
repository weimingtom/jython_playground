...
public class RaiseException extends JumpException
{
	...
	protected void setException(RubyException newException, boolean nativeException)
	{
		...
		{
			runtime.callTraceFunction("return", runtime.getCurrentContext().getPosition(), runtime.getCurrentContext().getCurrentFrame().getSelf(), runtime.getCurrentContext().getCurrentFrame().getLastFunc(), runtime.getCurrentContext().getCurrentFrame().getLastClass());
		}
